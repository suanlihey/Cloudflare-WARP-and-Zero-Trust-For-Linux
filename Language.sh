=======================================================
Cloudflare WARP Global Adaptor - External Language Pack
Version: 2026.02.18
...
L_1_opt_0="0. Exit"
L_1_back_hint="Hint: Enter '0' to return to main menu."
L_1_ctrl0_hint="Force Stop: Press Ctrl+C or use terminal Ctrl+0 mapping."
L_1_lang_select="Select Language / 请选择语言:"
L_1_installing="Installing Cloudflare WARP service..."
...
L_1_fail="Operation failed. Check network or Token."
L_1_team_ask="Use Zero Trust Team account? (y/n):"
L_1_token_ask="Enter Team Token (Leave empty for browser auth):"
L_1_name_ask="Enter Team Name (Organization):"
...
L_2_ctrl0_hint="强制终止：Ctrl+C 或 Ctrl+0 (需终端支持)"
L_2_installing="正在安装 Cloudflare WARP 服务..."
L_2_verifying="正在验证账户注册状态..."
L_2_mtu_detect="正在探测当前网络最优 MTU..."
L_2_team_ask="是否使用 Zero Trust Team 团队账户? (y/n):"
L_2_token_ask="输入 Team Token (自动化部署选填，无则留空):"
...
L_3_ctrl0_hint="Стоп: Ctrl+C или Ctrl+0."
L_3_installing="Установка службы Cloudflare WARP..."
L_3_verifying="Проверка статуса регистрации..."
L_3_mtu_detect="Определение оптимального MTU..."
L_3_team_ask="Использовать аккаунт Zero Trust Team? (y/n):"
L_3_token_ask="Введите Team Token (необязательно):"
L_3_name_ask="Введите Team Name (организация):"
...
L_4_ctrl0_hint="توقف اجباری: Ctrl+C یا نگاشت Ctrl+0."
L_4_installing="در حال نصب سرویس Cloudflare WARP..."
L_4_verifying="در حال بررسی وضعیت ثبت‌نام..."
L_4_mtu_detect="در حال شناسایی بهترین Path MTU..."
L_4_team_ask="آیا می‌خواهید از حساب Team استفاده کنید؟ (y/n):"
...
L_5_ctrl0_hint="強制終了: Ctrl+C または Ctrl+0。"
L_5_installing="Cloudflare WARP をインストール中..."
